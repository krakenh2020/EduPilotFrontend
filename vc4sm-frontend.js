let t,e,n,i,o,r,a,s,l,c,d,h,u,p,g,m,f,b,v,y,w=t=>t;function E(){return(E=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t}).apply(this,arguments)}
/*!
 ...
 */import{c as k,a as x,b as _}from"./shared/i18next.4eb888a0.es.js";import{A as S,g as L,c as C,h as I,p as T,a as A,S as R,u as P,I as O,D,b as F,e as N,f as U,L as $,d as j}from"./shared/dbp-lit-element.798cce61.es.js";import{c as B}from"./shared/class-map.6e632888.es.js";const M=k({en:{logo:{word1:"Science",word2:"Passion",word3:"Technology"},"privacy-policy":"Privacy Policy",imprint:"Legal Notice",contact:"Contact","page-updated-needs-reload":"The application has been updated. Please reload the page.","activity-example":{"hello-world":"Hello World"},welcome:{headline:"Welcome to the '{{appname}}' application."},login:"Login",logout:"Logout"},de:{logo:{word1:"Wissen",word2:"Technik",word3:"Leidenschaft"},"privacy-policy":"Datenschutz",imprint:"Impressum",contact:"Kontakt","page-updated-needs-reload":"Die Applikation wurde aktualisiert. Bitte laden Sie die Seite neu.","activity-example":{"hello-world":"Hallo Welt"},welcome:{headline:"Willkommen bei der Applikation '{{appname}}'."},login:"Einloggen",logout:"Ausloggen"}},"de","en");function G(){return M.cloneInstance()}const H=k({en:{de:"German",en:"English","de-action":"Switch to German","en-action":"Switch to English"},de:{de:"Deutsch",en:"Englisch","de-action":"Auf Deutsch anzeigen","en-action":"Auf Englisch anzeigen"}},"de","en");class z extends S{constructor(){super(),this._lang="de",this.languages=["de","en"],this.onExternalChange=this.onExternalChange.bind(this),H.t("de"),H.t("de-action"),H.t("en"),H.t("en-action")}_getNextLanguage(t){var e=this.languages.indexOf(t),n=this.languages[e+1];return void 0===n&&(n=this.languages[0]),n}_getPreviousLanguage(t){var e=this.languages.indexOf(t),n=this.languages[e-1];return void 0===n&&(n=this.languages[this.languages.length-1]),n}static get properties(){return{lang:{type:String},next:{type:String},languages:{type:Array}}}set lang(t){const e=this.lang,n=this.next;if(this._lang=t,this.requestUpdate("lang",e),this.requestUpdate("next",n),e!==t){let e=new CustomEvent("dbp-language-changed",{bubbles:!0,composed:!0,detail:{lang:t}});this.dispatchEvent(e),this.sendSetPropertyEvent("lang",t),H.changeLanguage(this.next)}}get lang(){return this._lang}set next(t){this.lang=this._getPreviousLanguage(t)}get next(){return this._getNextLanguage(this.lang)}static get styles(){return[L(),C(t||(t=w`
            :host {
...
/*! Universal Router | MIT License | https://www.kriasoft.com/universal-router/ */function gt(t,e,n){if(e.name&&t.has(e.name))throw new Error('Route "'+e.name+'" already exists');if(e.name&&t.set(e.name,e),n)for(var i=0;i<n.length;i++){var o=n[i];o.parent=e,gt(t,o,o.children)}}function mt(t,e){if(!t)throw new ReferenceError("Router is not defined");var n=new Map,i=new Map,o=Object.assign({encode:encodeURIComponent},e);return function(e,r){var a=n.get(e);if(!(a||(n.clear(),i.clear(),gt(n,t.root,t.root.children),a=n.get(e))))throw new Error('Route "'+e+'" not found');var s=i.get(a);if(!s){for(var l="",c=a;c;){var d=Array.isArray(c.path)?c.path[0]:c.path;d&&(l=d+l),c=c.parent}for(var h=ot(l,o),u=function(t,e){void 0===e&&(e={});var n=st(e),i=e.encode,o=void 0===i?function(t){return t}:i,r=e.validate,a=void 0===r||r,s=t.map((function(t){if("object"==typeof t)return new RegExp("^(?:"+t.pattern+")$",n)}));return function(e){for(var n="",i=0;i<t.length;i++){var r=t[i];if("string"!=typeof r){var l=e?e[r.name]:void 0,c="?"===r.modifier||"*"===r.modifier,d="*"===r.modifier||"+"===r.modifier;if(Array.isArray(l)){if(!d)throw new TypeError('Expected "'+r.name+'" to not repeat, but got an array');if(0===l.length){if(c)continue;throw new TypeError('Expected "'+r.name+'" to not be empty')}for(var h=0;h<l.length;h++){var u=o(l[h],r);if(a&&!s[i].test(u))throw new TypeError('Expected all "'+r.name+'" to match "'+r.pattern+'", but got "'+u+'"');n+=r.prefix+u+r.suffix}}else if("string"!=typeof l&&"number"!=typeof l){if(!c){var p=d?"an array":"a string";throw new TypeError('Expected "'+r.name+'" to be '+p)}}else{if(u=o(String(l),r),a&&!s[i].test(u))throw new TypeError('Expected "'+r.name+'" to match "'+r.pattern+'", but got "'+u+'"');n+=r.prefix+u+r.suffix}}else n+=r}return n}}(h,o),p=Object.create(null),g=0;g<h.length;g++){var m=h[g];"string"!=typeof m&&(p[m.name]=!0)}s={toPath:u,keys:p},i.set(a,s)}var f=t.baseUrl+s.toPath(r)||"/";if(o.stringifyQueryParams&&r){for(var b={},v=Object.keys(r),y=0;y<v.length;y++){var w=v[y];s.keys[w]||(b[w]=r[w])}var E=o.stringifyQueryParams(b);E&&(f+="?"===E.charAt(0)?E:"?"+E)}return f}}class ft{constructor(t,e,n){this.getState=e.getState,this.setState=e.setState,this.routeName=e.routeName,console.assert(this.getState),console.assert(this.setState),console.assert(this.routeName),this.router=new pt(t,n),window.addEventListener("popstate",(t=>{this.setStateFromCurrentLocation(),this.dispatchLocationChanged()}))}setStateFromCurrentLocation(){const t=location.pathname;this.router.resolve({pathname:t}).then((e=>{const n=this.getPathname(e);if(n!==t){const t=location.href;window.history.replaceState({},"",n),this.dispatchLocationChanged(t)}this.setState(e)})).catch((t=>{}))}update(){setTimeout((()=>{const t=this.getPathname();if(t===location.pathname)return;const e=location.href;window.history.pushState({},"",t),this.dispatchLocationChanged(e)}))}updateFromPathname(t){this.router.resolve({pathname:t}).then((e=>{if(location.pathname===t)return;const n=location.href;window.history.pushState({},"",t),this.setState(e),this.dispatchLocationChanged(n)})).catch((e=>{throw new Error(`Route not found: ${t}: ${e}`)}))}getPathname(t){void 0===t&&(t={});let e=E({},this.getState(),t);return mt(this.router)(this.routeName,e)}dispatchLocationChanged(t=""){window.dispatchEvent(new CustomEvent("locationchanged",{detail:{referrerUrl:t},bubbles:!0}))}}class bt extends S{constructor(){super(),this.env="",this.gitInfo="",this.buildUrl="",this.buildTime=""}static get properties(){return E({},super.properties,{env:{type:String},buildUrl:{type:String,attribute:"build-url"},buildTime:{type:String,attribute:"build-time"},gitInfo:{type:String,attribute:"git-info"}})}static get styles(){return C(c||(c=w`
        ...
        `),this.buildUrl,t.toString(),this.gitInfo,this.env)}}const vt=G();class yt extends S{constructor(){super(),this.lang=vt.language}static get properties(){return E({},super.properties,{lang:{type:String}})}update(t){t.forEach(((t,e)=>{"lang"===e&&vt.changeLanguage(this.lang)})),super.update(t)}static get styles(){return C(h||(h=w`
            ${0}
            ${0}
        ...
        `),vt.t("logo.word1"),vt.t("logo.word2"),vt.t("logo.word3"))}}const wt=G();class Et extends(R($)){constructor(){super(),this.lang=wt.language}static get properties(){return{lang:{type:String}}}static set app(t){this._app=t}update(t){t.forEach(((t,e)=>{"lang"===e&&wt.changeLanguage(this.lang)})),super.update(t)}static get styles(){return C(p||(p=w`
            ${0}
            ${0}
