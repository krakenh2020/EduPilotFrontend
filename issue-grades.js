 ...
 * @babel/runtime: MIT
 * i18next: MIT
 */import{c as o}from"./i18n.js";import{S as c,A as p,I as l,B as d,c as h,g as u,h as g,d as y}from"./shared/logger.da18e832.es.js";import{Q as f}from"./shared/qr-code.7c6f0a91.es.js";import"./shared/i18next.e2c56140.es.js";const m=o();class b extends(c(p)){constructor(){super(),this.auth={},this.entryPointUrl="",this.lang=m.language,this.exporting=!1}static get scopedElements(){return{"dbp-icon":l,"dbp-button":d,"dbp-qr-code":f}}static get properties(){return a({},super.properties,{lang:{type:String},exporting:{type:Boolean,attribute:!1},exportingId:{type:String},courseGrades:{type:Array},auth:{type:Object},entryPointUrl:{type:String,attribute:"entry-point-url"}})}connectedCallback(){super.connectedCallback()}update(t){t.forEach(((t,e)=>{switch(e){case"lang":m.changeLanguage(this.lang);break;case"entryPointUrl":this.fetchCourseGrades().then((t=>{this.courseGrades=t}))}})),super.update(t)}static get styles(){return h(t||(t=i`
            ${0}
